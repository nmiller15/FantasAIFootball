...
public class MondayLineupTask : ITask
{
    ...
    public string Name => nameof(MondayLineupTask);
    ...
    public async Task Execute()
    {
        ...
        var prompt = await _promptRepository.GetPrompt("monday_checks");
        ...
        var emailSubject = "Monday Lineup Recommendations";

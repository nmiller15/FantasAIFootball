...
public class TuesdayWaiverTask : ITask
{
    ...
    public string Name => nameof(TuesdayWaiverTask);
    ...
    public async Task Execute()
    {
        ...
        var prompt = await _promptRepository.GetPrompt("tuesday_waivers");
        ...
        var emailSubject = "Waiver Wire Recommendations";

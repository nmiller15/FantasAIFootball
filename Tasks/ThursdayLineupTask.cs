...
public class ThursdayLineupTask : ITask
{
    ...
    public string Name => nameof(ThursdayLineupTask);
    ...
    public async Task Execute()
    {
        ...
        var prompt = await _promptRepository.GetPrompt("thursday_checks");
        ...
        var emailSubject = "Thursday Lineup Recommendations";
